...
function _aerospace
    ...
    set --local literals "move-mouse" "--count" "-v" "smart" "macos-native-fullscreen" "mute-toggle" "height" "toggle" "all-monitors-outer-frame" "h_accordion" "--stdin" "--window-id" "monitor-force-center" "list-apps" "all" "flatten-workspace-tree" "mode" "width" "summon-workspace" "focus-back-and-forth" "list-monitors" "h_tiles" "prev" "window-force-center" "trigger-binding" "-h" "move-node-to-workspace" "wrap-around-the-workspace" "enable" "--ignore-floating" "--visible" "close-all-windows-but-current" "--help" "--macos-native-hidden" "off" "move-workspace-to-monitor" "--boundaries" "set" "workspace-back-and-forth" "--quit-if-last-window" "window-lazy-center" "workspace" "--major-keys" "accordion" "--focused" "tiling" "--app-bundle-id" "--mouse" "balance-sizes" "opposite" "on" "--auto-back-and-forth" "--version" "--json" "join-with" "reload-config" "--workspace" "floating" "--swap-focus" "--mode" "--boundaries-action" "resize" "visible" "close" "--no-stdin" "up" "layout" "--fail-if-noop" "list-exec-env-vars" "fail" "--monitor" "--focus-follows-window" "split" "--pid" "mute-on" "v_tiles" "monitor-lazy-center" "--keys" "wrap-around-all-monitors" "--wrap-around" "horizontal" "create-implicit-container" "config" "--no-outer-gaps" "focused" "mute-off" "--all-keys" "--all" "left" "right" "swap" "--config-path" "--get" "--empty" "tiles" "dfs-next" "--no-gui" "smart-opposite" "--format" "list-modes" "--dry-run" "move-node-to-monitor" "dfs-prev" "move" "focus" "down" "list-workspaces" "volume" "no" "stop" "debug-windows" "macos-native-minimize" "list-windows" "mouse" "next" "--dfs-index" "fullscreen" "focus-monitor" "--current" "v_accordion" "vertical"

    set --local descriptions

    set --local literal_transitions
    set literal_transitions[1] "set inputs 1 3 55 56 36 5 39 62 91 64 100 14 42 67 69 16 102 73 21 17 20 104 105 19 25 26 107 27 108 111 112 113 29 49 83 32 53 117 33 118; set tos 113 11 123 124 125 68 11 89 9 70 126 63 107 127 11 6 128 129 78 46 11 88 74 121 55 11 130 131 99 25 25 18 132 6 10 81 11 133 11 82"
    ...
    set literal_transitions[9] "set inputs 106 12 96 59 66 89 90 80 103; set tos 80 8 80 9 80 80 80 9 80"
    ...
    set literal_transitions[14] "set inputs 12 68; set tos 15 11"
    ...
    set literal_transitions[24] "set inputs 15 114 85; set tos 106 106 106"
    set literal_transitions[25] "set inputs 12; set tos 15"
    set literal_transitions[26] "set inputs 9 42; set tos 27 27"
    set literal_transitions[27] "set inputs 12 37 61; set tos 28 26 112"
    set literal_transitions[31] "set inputs 65 80 11; set tos 11 11 11"
    set literal_transitions[33] "set inputs 12 84 68; set tos 32 33 33"
    ...
    set literal_transitions[38] "set inputs 84 68 12 51; set tos 38 38 37 33"
    ...
    set literal_transitions[43] "set inputs 12 68; set tos 44 43"
    set literal_transitions[45] "set inputs 60; set tos 46"
    set literal_transitions[48] "set inputs 115 12 23 106 66 89 90 68 80 72; set tos 86 47 86 86 86 86 86 48 48 48"
    ...
    set literal_transitions[57] "set inputs 84 68 12 51; set tos 57 38 56 33"
    ...
    set literal_transitions[66] "set inputs 12 68 72; set tos 67 66 66"
    set literal_transitions[68] "set inputs 68 12 35 51; set tos 68 69 43 43"
    set literal_transitions[70] "set inputs 12 40; set tos 71 70"
    ...
    set literal_transitions[74] "set inputs 12 96 30 66 37 61 89 90 106 116 103; set tos 15 59 75 73 41 76 73 73 73 17 59"
    ...
    set literal_transitions[80] "set inputs 12 59 80; set tos 98 80 80"
    ...
    set literal_transitions[86] "set inputs 68 12 80 72; set tos 86 85 86 86"
    set literal_transitions[87] "set inputs 9 42; set tos 88 88"
    set literal_transitions[88] "set inputs 37 61 89 90 12 106 66; set tos 87 102 27 27 103 27 27"
    set literal_transitions[89] "set inputs 18 4 7 12 98; set tos 5 5 5 90 5"
    ...
    set literal_transitions[93] "set inputs 15 114 85; set tos 122 122 122"
    ...
    set literal_transitions[106] "set inputs 15 2 74 114 57 99 85 47 54 71; set tos 106 50 19 106 21 51 106 23 50 24"
    ...
    set literal_transitions[113] "set inputs 68 41 13 24 77; set tos 114 40 40 40 40"
    set literal_transitions[114] "set inputs 77 41 13 24; set tos 40 40 40 40"
    set literal_transitions[116] "set inputs 10 22 58 81 95 46 76 44 120 121; set tos 136 136 136 136 136 136 136 136 136 136"
    set literal_transitions[118] "set inputs 84 68 12 35 51; set tos 57 38 56 14 33"
    set literal_transitions[120] "set inputs 68 12 72; set tos 120 119 120"
    set literal_transitions[121] "set inputs 68; set tos 61"
    set literal_transitions[122] "set inputs 15 2 114 94 99 31 54 85; set tos 122 35 122 34 36 34 35 122"
    set literal_transitions[123] "set inputs 89 90 12 106 66; set tos 11 11 96 11 11"
    ...
    set literal_transitions[127] "set inputs 10 95 12 22 58 81 46 76 44 120 121; set tos 136 136 115 136 136 136 136 136 136 136 136"
    set literal_transitions[128] "set inputs 115 12 23 106 66 89 90 68 80 72; set tos 86 138 86 86 86 86 86 128 48 128"
    set literal_transitions[129] "set inputs 50 12 81 121; set tos 25 64 25 25"
    set literal_transitions[130] "set inputs 2 94 99 45 31 88 54 71; set tos 91 92 139 16 92 16 91 93"
    set literal_transitions[131] "set inputs 11 65 12 23 115 68 80 72; set tos 134 134 119 105 105 120 134 131"
    set literal_transitions[132] "set inputs 68 35 8 51; set tos 39 40 11 40"
    set literal_transitions[133] "set inputs 84 68 12 35 51; set tos 57 135 117 14 33"
    set literal_transitions[134] "set inputs 11 115 65 23 80 72; set tos 134 105 134 105 134 134"
    set literal_transitions[135] "set inputs 84 68 12 35 51; set tos 38 38 37 14 33"
    set literal_transitions[136] "set inputs 10 22 58 81 95 46 76 44 120 121; set tos 136 136 136 136 136 136 136 136 136 136"
    set literal_transitions[137] "set inputs 68 12 72; set tos 66 67 66"
