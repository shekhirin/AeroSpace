...
function _aerospace
    ...
    set --local literal_transitions
    set literal_transitions[1] "set inputs 1 3 55 56 36 5 39 62 91 64 100 15 42 67 69 16 102 73 25 20 19 104 105 17 24 27 107 26 108 111 112 113 29 49 83 32 53 117 33 118; set tos 113 11 123 124 125 70 11 89 9 72 126 65 107 127 11 6 128 129 55 121 11 88 76 46 79 11 130 131 99 25 25 18 132 6 10 81 11 133 11 82"
    ...
    set literal_transitions[42] "set inputs 37 61 89 90 106 30 66; set tos 41 104 75 75 75 42 75"
    set literal_transitions[43] "set inputs 13 68; set tos 44 43"
    set literal_transitions[45] "set inputs 60; set tos 46"
    set literal_transitions[48] "set inputs 115 13 22 106 66 89 90 68 80 72; set tos 86 47 86 86 86 86 86 48 48 48"
    ...
    set literal_transitions[52] "set inputs 89 90 106 22 115 66; set tos 54 54 54 54 54 54"
    set literal_transitions[53] "set inputs 80; set tos 11"
    set literal_transitions[54] "set inputs 80; set tos 11"
    set literal_transitions[55] "set inputs 2 99 54 48 45; set tos 55 56 55 57 57"
    set literal_transitions[57] "set inputs 109 2 99 54 48 45; set tos 55 55 56 55 57 57"
    set literal_transitions[59] "set inputs 84 68 13 51; set tos 59 38 58 33"
    set literal_transitions[60] "set inputs 110 28 70 79; set tos 61 61 61 61"
    set literal_transitions[61] "set inputs 61 30; set tos 60 61"
    set literal_transitions[62] "set inputs 54 78; set tos 62 62"
    set literal_transitions[65] "set inputs 2 99 54 34; set tos 65 64 65 94"
    set literal_transitions[67] "set inputs 81 121 50; set tos 25 25 25"
    set literal_transitions[68] "set inputs 13 68 72; set tos 69 68 68"
    set literal_transitions[70] "set inputs 68 13 35 51; set tos 70 71 43 43"
    set literal_transitions[72] "set inputs 13 40; set tos 73 72"
    set literal_transitions[74] "set inputs 110 28 70 79; set tos 75 75 75 75"
    set literal_transitions[75] "set inputs 37 61 30; set tos 95 74 75"
    set literal_transitions[76] "set inputs 13 96 30 66 37 61 89 90 106 116 103; set tos 15 61 77 75 41 78 75 75 75 17 61"
    set literal_transitions[77] "set inputs 106 96 30 66 37 61 89 90 103; set tos 75 61 77 75 41 78 75 75 61"
    set literal_transitions[78] "set inputs 110 28 70 79; set tos 77 77 77 77"
    set literal_transitions[79] "set inputs 60; set tos 29"
    set literal_transitions[80] "set inputs 13 59 80; set tos 98 80 80"
    set literal_transitions[81] "set inputs 40; set tos 11"
    set literal_transitions[82] "set inputs 115 106 22 66 89 90 80; set tos 54 54 54 54 54 54 84"
    set literal_transitions[84] "set inputs 89 90 115 106 22 66; set tos 54 54 54 54 54 54"
    ...
    set literal_transitions[94] "set inputs 109 2 99 54 34; set tos 65 65 64 65 94"
    set literal_transitions[95] "set inputs 9 42; set tos 75 75"
    ...
    set literal_transitions[107] "set inputs 11 115 65 22 52 68 80; set tos 108 31 108 31 110 110 108"
    set literal_transitions[108] "set inputs 22 115; set tos 31 31"
    ...
    set literal_transitions[113] "set inputs 68 41 14 23 77; set tos 114 40 40 40 40"
    set literal_transitions[114] "set inputs 77 41 14 23; set tos 40 40 40 40"
    set literal_transitions[116] "set inputs 10 21 58 81 95 46 76 44 120 121; set tos 136 136 136 136 136 136 136 136 136 136"
    set literal_transitions[118] "set inputs 84 68 13 35 51; set tos 59 38 58 14 33"
    set literal_transitions[120] "set inputs 68 13 72; set tos 120 119 120"
    set literal_transitions[121] "set inputs 68; set tos 63"
    ...
    set literal_transitions[125] "set inputs 115 106 22 66 89 90 80; set tos 54 54 54 54 54 54 52"
    set literal_transitions[126] "set inputs 119 2 54; set tos 126 126 126"
    set literal_transitions[127] "set inputs 10 95 13 21 58 81 46 76 44 120 121; set tos 136 136 115 136 136 136 136 136 136 136 136"
    set literal_transitions[128] "set inputs 115 13 22 106 66 89 90 68 80 72; set tos 86 138 86 86 86 86 86 128 48 128"
    set literal_transitions[129] "set inputs 50 13 81 121; set tos 25 66 25 25"
    set literal_transitions[130] "set inputs 2 94 99 45 31 88 54 71; set tos 91 92 139 16 92 16 91 93"
    set literal_transitions[131] "set inputs 11 65 13 22 115 68 80 72; set tos 134 134 119 105 105 120 134 131"
    set literal_transitions[132] "set inputs 68 35 8 51; set tos 39 40 11 40"
    set literal_transitions[133] "set inputs 84 68 13 35 51; set tos 59 135 117 14 33"
    set literal_transitions[134] "set inputs 11 115 65 22 80 72; set tos 134 105 134 105 134 134"
    set literal_transitions[135] "set inputs 84 68 13 35 51; set tos 38 38 37 14 33"
    set literal_transitions[136] "set inputs 10 21 58 81 95 46 76 44 120 121; set tos 136 136 136 136 136 136 136 136 136 136"
    set literal_transitions[137] "set inputs 68 13 72; set tos 68 69 68"

    set --local match_anything_transitions_from 7 24 131 37 128 125 122 44 79 66 96 47 106 46 85 119 83 21 29 82 36 56 63 111 28 69 103 139 64 53 58 138 137 117 51 2 22 52 71 93 120 100 19 107 32 98 121 15 30 90 8 73 23 13 110 17 115
    set --local match_anything_transitions_to 11 106 68 38 137 53 122 43 45 67 97 48 106 11 86 120 83 111 30 83 35 55 40 111 27 68 88 91 65 53 59 128 137 118 50 3 20 53 70 122 68 49 50 109 33 80 40 11 11 4 9 72 50 62 109 11 116
    ...
    set command_states 7 64 24 53 58 138 137 117 131 37 51 128 125 2 122 44 79 66 96 47 22 52 71 106 46 85 119 83 93 120 100 21 29 19 107 32 82 98 121 15 30 36 90 8 73 23 56 63 13 110 111 69 28 17 103 139 115
    set command_ids 55 56 40 56 57 57 56 57 55 57 56 56 56 56 40 57 49 57 57 57 56 56 57 40 19 57 57 56 40 55 56 55 19 43 55 57 56 57 55 57 49 56 57 57 57 53 56 55 54 55 55 57 57 56 57 56 57
    if contains $state $command_states
        set --local index (contains --index $state $command_states)
        set --local function_id $command_ids[$index]
